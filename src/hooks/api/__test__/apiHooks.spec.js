...
describe('Test apiHooks', () => {
  describe('Test useGetHistory hook', () => {
    ...
    it('Should get users history. DB has to have (10 < records < 13) for successful test, if geHistory recieves existing page number', async () => {
      let requestPromise;
      let state = hook[0];
      await act(async () => {
    ...
    it('Should get users history. DB has to have (10 < records < 13) for successful test, if geHistory recieves not existing page number', async () => {
      let requestPromise;
      let state = hook[0];
      await act(async () => {
    ...
    it('Should get users history. DB has to have (10 < records < 13) for successful test, if geHistory recieves not a number', async () => {
      let requestPromise;
      let state = hook[0];
      await act(async () => {
